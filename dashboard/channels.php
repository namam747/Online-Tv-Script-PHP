...
?>
        ...
        <div style="margin-top:60px;"></div>
            ...
            <div class="container">
                ...
                <div class="row">
                <div class="col-md-12">
<h2 class="animated" data-animation="fadeInUp" data-animation-delay="200" style="text-align:center;">Channels</h2>
                </div>
                </div>
...
<?php
    ...
    if (isset($_GET['id'])) {
        ...
        $single_stmt = mysql_query('SELECT cnm, code FROM channel WHERE typ=\'1\' AND id=\''.$id.'\'');
        if ($single = mysql_fetch_array($single_stmt)) {
            ...
            $ddaa = mysql_query("SELECT id, cnm, img FROM channel WHERE typ='1'");
            echo mysql_error();
            ...
            echo "<div class=\"col-sm-4\">
                  ...
                  <div class=\"panel-heading\"><h3 class=\"panel-title\" style=\"font-size:20px\">$data[1]</h3></div>
                    <div class=\"panel-body\">
                   <a href=\"$dashurl/channels/$data[0]\"><img class=\"img-responsive\" src=\"$img\" alt=\"$data[1]\"></a>
                    </div></div></div>";
